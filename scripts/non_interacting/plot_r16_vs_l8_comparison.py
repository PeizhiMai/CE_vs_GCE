...
SQUARE_DIR = ROOT / "results" / "non_interacting" / "spinless_square_pbc_comparison_by_L" / "L_8"
OUT_DIR = ROOT / "results" / "non_interacting" / "r16_vs_l8_comparison"
...
def write_metadata(
    ...
    lines = [
        ...
        'data_sources = "results/non_interacting/spinless_disk_comparison_by_radius/radius_16 and results/non_interacting/spinless_square_pbc_comparison_by_L/L_8"',
    ]
    path.parent.mkdir(parents=True, exist_ok=True)
    path.write_text("\n".join(lines) + "\n")
