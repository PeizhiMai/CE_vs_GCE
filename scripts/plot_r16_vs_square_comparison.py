...
SQUARE_RESULTS_DIR = ROOT / "results" / "spinless_square_pbc_comparison_by_L"
...
def write_metadata(
    ...
    lines = [
        ...
        f'data_sources = "results/spinless_disk_comparison_by_radius/radius_16 and results/spinless_square_pbc_comparison_by_L/L_{square_L}"',
    ]
    path.parent.mkdir(parents=True, exist_ok=True)
    path.write_text("\n".join(lines) + "\n")
