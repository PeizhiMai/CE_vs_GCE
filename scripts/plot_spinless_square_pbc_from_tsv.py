...
DEFAULT_RESULTS_DIR = ROOT / "results" / "spinless_square_pbc_comparison_by_L"
...
def make_plot(
    ...
    ax.plot(temps, gce_values[order], color="#7570b3", linewidth=2.0, label="GCE")
    ax.plot(temps, ce_values[order], color="#e7298a", linewidth=2.0, linestyle="--", label="CE")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Replot saved square-lattice PBC CE/GCE results from existing TSV files."
    )
    parser.add_argument(
        "--Ls",
    ...
    parser.add_argument(
        ...
        help="Directory containing existing square-lattice result folders.",
    )
...
def main() -> None:
    ...
    print("Replotted saved square-lattice PBC figures from TSV data")
