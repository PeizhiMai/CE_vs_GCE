...
DEFAULT_OUT_DIR = ROOT / "results" / "spinless_square_obc_comparison_by_L"
...
def make_plot(
    ...
    ax.plot(temperatures[order], gce_values[order], color="#7570b3", linewidth=2.0, label="GCE")
    ax.plot(temperatures[order], ce_values[order], color="#e7298a", linewidth=2.0, linestyle="--", label="CE")
